...
public class MyJFrame extends JFrame {
	...
	// Reset class variables and get matching summary
	...
	// Get no. of transactions in each file, how many match and how many do not match
    ...
    // Create container panel for panel 1
    ...
    // Create container panel for all 3 panels
	public void CreateContainerForJPanel1And2And3(){
    	...
    	// Only get unmatched data if unmatched data exists
	...
	// Create container panel for panel 1 and 2
	...
	// Create panel and add 2 labels, two textAreas (file name) and 3 buttons with listeners
    ...
    // create container panel and call two sub panels and add button with listener
	...
	// Create panel and add two tables with details of unmatched transactions
	...
	// Create panel and add table with matching summary of file 2
	...
	// Create panel and add table with matching summary of file 1
	...
	// Set Almost matched (every member except one matches) transactions
